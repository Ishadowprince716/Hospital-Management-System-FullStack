        ...
        >
            <div className="flex flex-col h-full">
                ...
                <div className="flex items-center px-6 py-5 border-b" style={{ borderColor: 'var(--border-color)' }}>
                    <div className={`flex items-center justify-center w-10 h-10 rounded-xl ${accentColor} shadow-lg mr-3`}>
                ...
                {/* User badge */}
                <div className="px-4 py-3 mx-3 mt-3 rounded-xl" style={{ background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.15)' }}>
                ...
                <div className="p-3 border-t" style={{ borderColor: 'var(--border-color)' }}>
                    <button
                        ...
                        className="flex items-center w-full px-3 py-2.5 text-sm font-medium rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                    >
